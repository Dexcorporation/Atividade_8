public class GerenciadorDePessoas {
   ...
   private pessoa pessoa2;
    ...
    public static void main(String[] args){
        ...
        pessoa pessoa1 = new pessoa("Mario", "725.781.910-02", 37);
        pessoa pessoa2 = new pessoa("José", "111.245.783-14", 20);
        ...
        pessoa novaPessoa1 = new pessoa("Mario Silveira", "725.781.910-02", 37);
